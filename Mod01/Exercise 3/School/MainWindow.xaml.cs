        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Delete:
                    ...
                    Student selectedStudent = this.studentsList.SelectedItem as Student;
                    string message = "Remove " + selectedStudent.FirstName + " " + selectedStudent.LastName + "?";
                    ...
                    {
                        this.schoolContext.Students.DeleteObject(selectedStudent);
