...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                case Key.Enter:
                    this.student = studentsList.SelectedItem as Student;
                    StudentForm sf = new StudentForm();
                    sf.Title = "Edit Student Details";
                    sf.firstName.Text = this.student.FirstName;
                    sf.lastName.Text = this.student.LastName;
                    sf.dateOfBirth.Text = this.student.DateOfBirth.ToString("d");
                    sf.ShowDialog();

                    if (sf.DialogResult == true)
                    {
                        this.student.FirstName = sf.firstName.Text;
                        this.student.LastName = sf.lastName.Text;
                        this.student.DateOfBirth = DateTime.Parse(sf.dateOfBirth.Text);
