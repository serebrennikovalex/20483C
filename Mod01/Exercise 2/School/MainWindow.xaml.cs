    ...
    public partial class MainWindow : Window
    {
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Insert:
                    StudentForm sfInsert = new StudentForm();

                    sfInsert.Title = "New Student for Class" + teacher.Class;
                    sfInsert.ShowDialog();

                    if (sfInsert.DialogResult == true)
                    {
                        Student newStudent = new Student();
                        newStudent.FirstName = sfInsert.firstName.Text;
                        newStudent.LastName = sfInsert.lastName.Text;
                        newStudent.DateOfBirth = DateTime.Parse(sfInsert.dateOfBirth.Text, CultureInfo.InvariantCulture);
