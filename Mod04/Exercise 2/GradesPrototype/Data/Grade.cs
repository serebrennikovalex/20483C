...
namespace GradesPrototype.Data
{
    ...
    public class Grade
    {
        ...
        public string AssessmentDate {
            ...
            set
            {
                ...
                if (DateTime.TryParse(value, out assessmentDate))
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("assessmentDate", "The date is no later than the current date");
                    }

                    _assessmentDate = assessmentDate.ToString("d", CultureInfo.GetCultureInfo("es-ES"));
                } else
                {
                    throw new ArgumentException("The date is not in a valid format", "assessmentDate");
                }
        ...
        public string SubjectName {
            ...
            set
            {
                if (DataSource.Subjects.IndexOf(value) < 0)
                {
                    throw new ArgumentException("The subject is not valid", "subject");
                }
        ...
        public string Assessment { 
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("The grade is not valid", "assessment");
                }
