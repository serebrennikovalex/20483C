...
namespace GradesPrototype.Data
{
    ...
    public class Student: IComparable<Student>
    {
        ...
        public void AddGrade(Grade grade)
        {
            ...
            {
                throw new ArgumentException("Grade belongs to a different student", "grade");
            }
    ...
    public class Teacher
    {
        ...
        public void EnrollInClass(Student student)
        {
            ...
            {
                throw new ArgumentException("Student is already assigned to a class", "student");
            }
        ...
        public void RemoveFromClass(Student student)
        {
            ...
            {
                throw new ArgumentException("Student is not assigned to this class", "student");
            }
